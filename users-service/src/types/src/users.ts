...
export interface FindUserFollowersParams {
  userId: string;
}

export interface FindUserFollowersResponse {
  data: string[];
}

export interface UsersService {
  findManyByIds(request: FindManyByIdsParams): Observable<FindManyByIdsResponse>;
  findUserFollowers(request: FindUserFollowersParams): Observable<FindUserFollowersResponse>;
}
